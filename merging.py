...
"""
возращаем tuple из трех таблиц, где в 0 указано кто и куда летел, в 1 указано кто использовал чужую программу лояльности, во 2 все люди которые есть в базе и их индификаторы
"""
def merge_yjx(yaml_path, json_path, xml_path):
    """
    В a_df, b_df, cd_df мы храним дата фреймы полученные после прасинга соотвествующих файлов  yaml_path, json_path, xml_path
    """
